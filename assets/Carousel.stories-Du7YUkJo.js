import{r as i,j as e}from"./iframe-nAd84LC9.js";import{r as D,a as A,D as P,E as O}from"./YoutubeIcon-Dg_Bzto8.js";import"./SearchIcon-BrpBgOxV.js";import{C as B}from"./Card-CNTEV7k-.js";import{b as q}from"./index-Cn1xQXcm.js";import{B as V}from"./Button-DfnPG2aG.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CuJYthOG.js";import"./index-JC5pM8TX.js";import"./styles-DSBOcsIh.js";import"./Text-COwCCMvo.js";function L(t,a){const[s,n]=i.useState(t?"entered":"exited"),l=i.useRef(t),r=i.useRef(null);return i.useEffect(()=>{l.current!==t&&(n(t?o=>o==="entering"||o==="entered"?o:"entering":o=>o==="exiting"||o==="exited"?o:"exiting"),l.current=t)},[t]),i.useEffect(()=>{const o=r.current;if(!o)return;const v=m=>{m.target===o&&m.propertyName===a&&n(c=>c==="entering"?"entered":c==="exiting"?"exited":c)};return o.addEventListener("transitionend",v),()=>o.removeEventListener("transitionend",v)},[a]),{state:s,ref:r,attributes:{"data-entering":s==="entering"?"":void 0,"data-entered":s==="entered"?"":void 0,"data-exiting":s==="exiting"?"":void 0,"data-exited":s==="exited"?"":void 0,"data-transition":s}}}const z=i.createContext(null);function C(){const t=i.useContext(z);if(!t)throw new Error("useCarousel must be used within the CarouselContext");return t}function f({children:t,duration:a=4e3,className:s}){const[n,l]=i.useState(0),[r,d]=i.useState(0),[o,v]=i.useState(!1),[m,c]=i.useState("rtl");function E(u){d(k=>{let p=u;return u>n-1?p=0:u<0&&(p=n-1),k===n-1&&p===0?c("rtl"):k===0&&p===n-1?c("ltr"):c(p<k?"ltr":"rtl"),p})}function b(){d(u=>(c("rtl"),u===n-1?0:u+1))}function I(){d(u=>(c("ltr"),u===0?n-1:u-1))}const w=a>0;return i.useEffect(()=>{if(!w||o)return;const u=setInterval(()=>{b()},a);return()=>{clearInterval(u)}},[w,o,a,r,b]),e.jsx(z.Provider,{value:{nextSlide:b,prevSlide:I,setSlide:E,isPaused:o,setPaused:v,autoAdvance:w,duration:a,totalSlides:n,setTotalSlides:l,currentSlide:r,direction:m},children:e.jsx("div",{"data-slot":"carousel",role:"region","aria-roledescription":"carousel",className:q(s),style:{"--duration":`${a}ms`},children:t})})}function y({children:t}){const{setPaused:a,setTotalSlides:s}=C(),n=i.Children.toArray(t).filter(r=>i.isValidElement(r)&&r.type===x).map((r,d)=>i.isValidElement(r)?i.cloneElement(r,{index:d}):r),l=n.length;return i.useEffect(()=>{s(l)},[s,l]),e.jsx("div",{"data-slot":"carousel-deck",className:"relative z-2 grid-stack rounded-3xl focus-within:ring-2 ring-black",onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),onFocus:()=>a(!0),onBlur:()=>a(!1),children:n})}function x({children:t,className:a,index:s=0}){const{direction:n,currentSlide:l}=C(),{ref:r,attributes:d}=L(l===s,"opacity");return e.jsx("div",{inert:l!==s||void 0,"data-index":s,"data-slot":"carousel-slide","data-current":l===s||void 0,"data-ltr":n==="ltr"||void 0,className:q(`
