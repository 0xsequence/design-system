  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          'bg-background-primary border-transparent data-[open]:animate-in data-[closed]:animate-out fixed z-50 flex flex-col gap-4 transition ease-in-out data-[closed]:duration-300 data-[open]:duration-500',
          side === 'right' &&
