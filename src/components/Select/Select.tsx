    ...
    <SelectPrimitive.Portal container={container}>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            'bg-background-raised text-primary relative z-50 max-h-(--available-height) min-w-[8rem] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border border-border-normal shadow-primary',
