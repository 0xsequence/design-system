...
export type Accent = 'blue' | 'green' | 'indigo' | 'orange' | 'pink' | 'purple' | 'red' | 'teal' | 'yellow'

const accents: { [key in ColorScheme]: { [key in Accent]: string } } = {
  light: {
    blue: '0, 122, 255',
    green: '52, 199, 89',
    indigo: '88, 84, 214',
...
export const colors = {
  ...
  dark: {
    ...normalizeRadixColorScale(grayDark)
    // background: '20, 20, 20',
